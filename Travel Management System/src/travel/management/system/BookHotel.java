...
public class BookHotel extends JFrame implements ActionListener {
    ...
    BookHotel(String username){
       ...
       lblperson.setFont(new Font("Times New Roman", Font.PLAIN, 16));
       ...
       lblnumber.setFont(new Font("Times New Roman", Font.PLAIN, 16));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == checkprice) {
            try{
            Conn c = new Conn();
            ResultSet rs = c.s.executeQuery("select * from hotel where hotel='"+chotel.getSelectedItem()+"'");
            while(rs.next()){
